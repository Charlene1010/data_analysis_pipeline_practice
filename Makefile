...
report/count_report.html: report/count_report.qmd \
                          results/abyss.dat results/isles.dat results/last.dat results/sierra.dat \
                          results/figure/abyss.png results/figure/isles.png results/figure/last.png results/figure/sierra.png
